...
<body style="word-spacing:normal;background-color:#e8ebf3;">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Helvetica, Arial, sans-serif;font-size:15px;font-weight:300;line-height:24px;text-align:left;color:#000000;">
                                  ...
                                  ${this.getRegistered(regCampers, shifts)}
                                  ${this.nonRegistered(resCampers)}
                                  ...
                                  <p>Tasuda: ${
                                    100 * regCampers.length
                                  } €. Kogusumma (k.a broneerimistasu): ${totalPrice} €.</p>
  ...
  private static nonRegistered = (campers: Registration[]) => {
    let response = "<ul>";
  ...
  private static getStaffContacts = (shifts: number[]) => {
    let response = "";
